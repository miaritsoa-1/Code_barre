...
button_code_bar.onclick = function() {
    if (text.value.length > 0) {
        if (text.value.length < 50) {
            ...
            // créer un bouton pour télécharger le code-barres
            pdf_box.innerHTML = "<button onclick='okPDF()'>Télécharger le code-barres</button>";
            // styliser la boîte du bouton pdf
...
function genererPDF() {
    ...
    // nouvelle utilisation basée sur les promesses
